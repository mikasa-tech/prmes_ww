...
## 5. CD Presentation Checklist
If you are moving this file to a **CD** for your project presentation, here is exactly what you need to ensure success on the day:

*   **[ ] The Zip File**: Copy the `project_pro.zip` from your Desktop onto the CD.
*   **[ ] Python Check**: Ensure the presentation laptop has **Python 3.10+** installed.
*   **[ ] Library Setup**: If the laptop is new, you will need an internet connection for *one minute* to install dependencies:
    ```cmd
    pip install -r requirements.txt
    ```
*   **[ ] Extraction**: Remember, you **cannot** run the app directly from the CD. You must copy the zip to the laptop's Desktop and **Extract** it there first.
*   **[ ] Database**: Everything (your students, reviews, and reports) is stored in `app.db` inside the zip. It will move with you perfectly!
